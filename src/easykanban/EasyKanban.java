...
public class EasyKanban {
    ...
    public static void main(String[] args) {
        ...
        if (!loggedIn) {
            JOptionPane.showMessageDialog(null, "Login failed. END OF SESSION!");
            System.exit(0);
        }
    ...
    private static boolean login() {
        ...
        String username = JOptionPane.showInputDialog("Enter username: (Password: LERATO)");;
        String password = JOptionPane.showInputDialog("Enter password: (Username: 123456789)");
        // In a real application, you'd check the username and password against a database or other data source.
        return username.equals("LERATO") && password.equals("123456789");
    }
